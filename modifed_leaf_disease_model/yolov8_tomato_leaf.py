...
Original file is located at
    https://colab.research.google.com/#fileId=https%3A//storage.googleapis.com/kaggle-colab-exported-notebooks/ahmednasser83/yolov8-tomato-leaf.35a44a4a-4085-44e1-ab36-fe12ba239313.ipynb%3FX-Goog-Algorithm%3DGOOG4-RSA-SHA256%26X-Goog-Credential%3Dgcp-kaggle-com%2540kaggle-161607.iam.gserviceaccount.com/20250513/auto/storage/goog4_request%26X-Goog-Date%3D20250513T174929Z%26X-Goog-Expires%3D259200%26X-Goog-SignedHeaders%3Dhost%26X-Goog-Signature%
"""
...
results = model.train(
    data= '/kaggle/input/dataaa/data (10) (2).yaml',  # Dataset YAML
    epochs=120,
    seed=42,
    imgsz=640,
    conf=0.5,
...
validate = model.val(
    data='/kaggle/input/dataaa/data (10) (2).yaml',  # Path to your dataset YAML file
    imgsz=640,                            # Image size (optional)
    batch=32                               # Batch size (optional)
)

test_images_path='/kaggle/input/tomato-leaf-disease-dataset/Tomato-Leaf-Disease-63/test/images'
